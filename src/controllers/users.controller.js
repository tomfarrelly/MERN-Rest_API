import bcrypt from "bcryptjs"; // importing bcrypt for hashing functionality
import jwt from "jsonwebtoken"; // importing jwt for encoding claims



import UsersDAO from "../dao/users.dao.js";

// hashing password utilizing bcrypt
...
export default class UsersController {
    // function to register users to the db
    static async register(req, res) {
        try {
            ...
            res.json({
                auth_token: user.encoded(), // encodes user token for authorization
                info: user.toJson(),
            });
        } 
        catch (e) {
    ...
    static async save(req, res) {
        ...
        try {
            ...
            // json response encoding authorization token
            res.json({
